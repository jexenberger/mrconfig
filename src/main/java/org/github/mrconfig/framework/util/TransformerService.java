...
import static org.github.mrconfig.framework.util.ReflectionUtil.invoke;
...
public class TransformerService {
    ...
    static {
        ...
        registerConversion(Number.class, Boolean.class, Transformations::toBoolean);
        registerConversion(String.class, Date.class, Transformations::stringToDate);
        registerConversion(Date.class, String.class, Transformations::dateToString);
    }
