...
public class UX {
    ...
    public UX(View uniqueView, View getView, View putView, View postView, Resource resource) {
        this();
    ...
    public UX(View listView, View editView, Resource resource) {
    ...
    public static UX defaultView(Resource resource, Function<Resource,Form> formSupplier) {
        return new UX(templateView("list_form.ftl"),templateView("edit_form.ftl"), resource).formSupplier(formSupplier);
    }
    ...
    public UX getView(View getView) {
        this.getView = getView;
        registerDefaultViews();
        return this;
    }

    public UX putView(View putView) {
        this.putView = putView;
        registerDefaultViews();
        return this;
    }

    public UX postView(View postView) {
        this.postView = postView;
        registerDefaultViews();
        return this;
    }

    public UX addView(String mapping, View view) {
    ...
    public UX formSupplier(Function<Resource,Form> supplier) {
